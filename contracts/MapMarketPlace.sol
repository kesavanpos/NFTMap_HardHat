import "./MapOwnerShip.sol";

// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.11;


contract MapMarketPlace is MapOwnership {
    ...
    public
  {
    ...
    require(offer.seller == msg.sender, "You should own the map to be able to remove this offer");
  ...
  function buyMap(uint256 _tokenId)
    public
    payable
  {
    Offer memory offer = tokenIdToOffer[_tokenId];
